...
function newscard_widgets_init() {
	...
	register_sidebar( array(
		'name' 					=> __('Home Page', 'newscard') ,
		'id' 						=> 'newscard_home_page',
		'description' 	=> __('Shows the widgets on the home page, below news.', 'newscard'),
		'before_widget' => '<div class="row mb-30"><div class="col">',
