 ...
 *
 */
function newscard_develop_link() {
	return '<div class="wp-link">' .
		sprintf(
			esc_html__('Proudly Powered by: %s', 'newscard'),
			'<a href="' . esc_url('https://www.linkedin.com/in/weslanra/') . '" target="_blank" title="' . esc_attr__('Weslan Alves', 'newscard') . '">' . esc_html__('Weslan Alves', 'newscard') . '</a>'
		) . '</div>';
}
/**
 * To display a link to WordPress.org.
