...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<div class="wrapper-sort-number">
			<span id="bom-pastor-number" class="number">--</span>
			<button onclick="drawNumber('bom-pastor-number')" class="btn btn-theme btn-number-random">Sortear</button>
		</div>
	</div><!-- .entry-content -->
	<?php 
		wp_link_pages( array(
